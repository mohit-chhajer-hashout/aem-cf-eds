...
## Environments
- Preview: https://main--aem-cf-eds--mohit-chhajer-hashout.aem.page/
- Live: https://main--aem-cf-eds--mohit-chhajer-hashout.aem.live/
...
1. Open the `aem-cf-eds` directory in your favorite IDE and start coding :)
